...
(function ( root, doc, factory ) {
	if ( typeof define === "function" && define.amd ) {
        ...
        // @AJAXY HACK jqmSettings
		define( [ "jquery", '../../../jqmSettings' ], function ( $ ) {
			factory( $, root, doc );
			return $.mobile;
		});
	} else {
...
(function( $, undefined ) {
	...
	$.mobile.focusPage = function ( page ) {
		...
		if ( pageTitle.length ) {
            ...
            // @AJAXY HACK VK scroll to iframe workaround https://github.com/Ajaxy/Mozg/issues/152
            if (!(location && location.search.match(/env=app-vkontakte/))) {
                page.focus();
            }
		}
	};
